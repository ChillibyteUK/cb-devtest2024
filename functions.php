...
define('CB_THEME_DIR', WP_CONTENT_DIR . '/themes/cb-devtest2024');
...
function theme_enqueue_styles() {
	...
	wp_enqueue_style( 'child-understrap-styles', get_stylesheet_directory_uri() . $theme_styles, array(), '1234' );
...
function add_child_theme_textdomain() {
	load_child_theme_textdomain( 'cb-devtest2024', get_stylesheet_directory() . '/languages' );
}
